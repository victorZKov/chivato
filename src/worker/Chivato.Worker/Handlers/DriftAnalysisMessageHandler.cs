...
/// <summary>
/// Service Bus message handler for drift analysis requests
/// </summary>
public class DriftAnalysisMessageHandler : BackgroundService
{
    ...
    private readonly ILogger<DriftAnalysisMessageHandler> _logger;

    private const string QueueName = "drift-analysis-requests";

    public DriftAnalysisMessageHandler(
        string connectionString,
        IDriftAnalysisProcessor analysisProcessor,
        IStorageService storageService,
        ISignalRService signalRService,
        ILogger<DriftAnalysisMessageHandler> logger)
    {
